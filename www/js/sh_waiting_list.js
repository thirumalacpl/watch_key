...
$(document).off('click', '#dashcooiweraabb').on('click', '#dashcooiweraabb', function() {
  
  $.mobile.changePage($('#dashboard_sh'), { transition: "none", changeHash: true, reverse: false });
return false;
});

 $(document).off('click', '#newsheraabb').on('click', '#newsheraabb', function() {
...
return false;
 ...
 $(document).off('click', '#newlistinbbqqdf').on('click', '#newlistinbbqqdf', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
  ...
  $(document).off('click', '#shapprovedinuoaabb').on('click', '#shapprovedinuoaabb', function() {
  //sessionStorage.getItem.clear;
...
return false;
      ...
      $(document).off('click', '#completedshiooaabb').on('click', '#completedshiooaabb', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                  ...
                  $(document).off('click', '#rejectieiopaabb').on('click', '#rejectieiopaabb', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                        ...
                        $(document).off('click', '#verifalyuiaabb').on('click', '#verifalyuiaabb', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
    ...
    $(document).off('click', '#signoutcooieraabb').on('click', '#signoutcooieraabb', function() {
