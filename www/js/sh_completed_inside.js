$(document).on('pageshow', '#sh_completed_inside', function(){  
//alert("sh_completed_inside");
...
$(document).off('click', '#dashcooiuoiiqwwapcc').on('click', '#dashcooiuoiiqwwapcc', function() {

  $.mobile.changePage($('#dashboard_sh'), { transition: "none", changeHash: true, reverse: false });
return false;
});

  $(document).off('click', '#erdsfqwwapcc').on('click', '#erdsfqwwapcc', function() {
...
return false;
 ...
 $(document).off('click', '#inprogresscooiuoiiqwwapcc').on('click', '#inprogresscooiuoiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
  ...
  $(document).off('click', '#waitinguoiiqwwapcc').on('click', '#waitinguoiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
...
return false;
 ...
 $(document).off('click', '#shapproveduoiiqwwapcc').on('click', '#shapproveduoiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
...
return false;
      ...
      $(document).off('click', '#completedshuoiiiqwwapcc').on('click', '#completedshuoiiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
  $.mobile.changePage($('#sh_completed_list'), { transition: "none", changeHash: true, reverse: false });
return false;
});
                  $(document).off('click', '#shnotveriuoiqwwapcc').on('click', '#shnotveriuoiqwwapcc', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
            ...
            $(document).off('click', '#rejectieiuoiiqwwapcc').on('click', '#rejectieiuoiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
$(document).off('click', '#verifaluoiiqwwapcc').on('click', '#verifaluoiiqwwapcc', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
    ...
    $(document).off('click', '#signoutcooiiiqwwapcc').on('click', '#signoutcooiiiqwwapcc', function() {
...
if (superfin !== null){
$("#supp_shc").text(supervisor_final_commanda.final_Command);
}
...
//alert(oneemp);
  $('.ssnewinpc').append('<li><a href="http://staging.eimpressive.com/watchguardlive/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewinpc').append('<li><a href="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.completedc').append('<img src="http://staging.eimpressive.com/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.completedd').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.completedb').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.completeda').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.completede').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.completedf').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
