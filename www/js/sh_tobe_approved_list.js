...
$(document).off('click', '#dashcooiweraabbq').on('click', '#dashcooiweraabbq', function() {
  
  $.mobile.changePage($('#dashboard_sh'), { transition: "none", changeHash: true, reverse: false });
return false;
});

 $(document).off('click', '#newsheraabbq').on('click', '#newsheraabbq', function() {
...
return false;
 ...
 $(document).off('click', '#newlistinbbq').on('click', '#newlistinbbq', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
  ...
  $(document).off('click', '#shapprovedinuoaabbq').on('click', '#shapprovedinuoaabbq', function() {
  //sessionStorage.getItem.clear;
...
return false;
 ...
 $(document).off('click', '#shapprovedzoneaabb').on('click', '#shapprovedzoneaabb', function() {
  //sessionStorage.getItem.clear;
...
return false;
      ...
      $(document).off('click', '#completedshiooaabbq').on('click', '#completedshiooaabbq', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                  ...
                  $(document).off('click', '#rejectieiopaabbq').on('click', '#rejectieiopaabbq', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                        ...
                        $(document).off('click', '#verifalyuiaabbq').on('click', '#verifalyuiaabbq', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
    ...
    $(document).off('click', '#signoutcooieraabbq').on('click', '#signoutcooieraabbq', function() {
...
if(qualification_id == '69' ){
//alert('function professionl id 69');
